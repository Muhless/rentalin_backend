            ...
            <tbody class="text-gray-700">
                @forelse ($rentals as $rental)
                    <tr class="text-sm">
                        ...
                        <td class="text-center mx-2 py-2 rounded-lg border border-gray-300 text-black" readonly
                            @if ($rental->status === 'Sedang Berlangsung') bg-blue-200
                            @elseif ($rental->status === 'Selesai') bg-green-200
                            @elseif ($rental->status === 'Dibatalkan') bg-red-200 @endif
                            text-black">
                            {{ $rental->status }}
                        </td>
                    </tr>
